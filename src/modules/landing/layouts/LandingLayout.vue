  ...
  <div class="flex flex-col h-screen">
    ...
    <header class="flex items-center h-14 px-4 border-b border-gray-300 sm:h-16 md:px-6 lg:px-8">
      ...
      <nav class="ml-auto space-x-4 flex items-center h-10 sm:space-x-6">
        <RouterLink :to="{ name: 'home' }" exact-active-class="underline font-bold transition-all"
          >Home</RouterLink
        >
        ...
        <RouterLink :to="{ name: 'login' }" exact-active-class="underline font-bold transition-all"
          >Login</RouterLink
        >
      </nav>
    </header>
